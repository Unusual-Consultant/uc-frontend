...
>
  <CardContent className="p-4 pt-[10px]"> {/* Added padding-top */}
              ...
              {mentor.available ? "Quick Book" : "Unavailable"}
               ...
               <div className="absolute -bottom-10 right-0 flex gap-3">
                <button
                  ...
                  className="w-6 h-6 flex items-center justify-center bg-white border border-gray-300 rounded-full hover:bg-gray-100 shadow-sm transition "
                >
                  <ChevronLeft size={16} />
                </button>
                <button
      ...
      <div className="text-[16px] text-black font-[600]">
        {t.role} at {t.company}
                ...
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center bg-white border border-gray-300 rounded-full hover:bg-gray-100 shadow-sm transition"
                >
                  <ChevronLeft size={16} />
                </button>
                <button
