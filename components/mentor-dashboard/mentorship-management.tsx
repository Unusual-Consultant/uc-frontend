...
export function MentorshipManagement() {
  ...
  {/* Tabs List */}
  <TabsList className="grid grid-cols-2 bg-white rounded-full border border-gray-200 p-1">
  <TabsTrigger
    value="upcoming"
  ...
  <TabsContent value="upcoming" className="mt-4">
      ...
      <div className="rounded-xl bg-[#F8F9FB] border border-[#DADADA] p-6 space-y-4">
